...
def page_2():
    with st.sidebar:
        st.header('Tensorflow Playground_AI-ELITE-14')
        # Creating Random Data set-----------------------------------------------------------------------------------------------------------------
        filepath = 'c:/Users/HOME/Downloads'
        u_shape = pd.read_csv(f'{filepath}/1.ushape.csv')
        concentric_circle_1 = pd.read_csv(f'{filepath}/2.concerticcir1.csv')
        concentric_circle_2 = pd.read_csv(f'{filepath}/3.concertriccir2.csv')
        linearly_Separable = pd.read_csv(f'{filepath}/4.linearsep.csv')
        outlier = pd.read_csv(f'{filepath}/5.outlier.csv')
        overlap = pd.read_csv(f'{filepath}/6.overlap.csv')
        xor = pd.read_csv(f'{filepath}/7.xor.csv')
        two_spiral = pd.read_csv(f'{filepath}/8.twospirals.csv')
